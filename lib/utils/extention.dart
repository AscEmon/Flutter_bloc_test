...
// Use this extention to check all the getStatus when using bloc.
extension AllGetStatusX on AllGetStatus {
  bool get isInitial => this == AllGetStatus.initial;
  bool get isSuccess => this == AllGetStatus.success;
  bool get isError => this == AllGetStatus.error;
  bool get isLoading => this == AllGetStatus.loading;
}

// Use this extention to check all the PostStatus when using bloc.
extension AllPostStatusX on AllPostStatus {
  bool get isInitial => this == AllPostStatus.initial;
  bool get isSuccess => this == AllPostStatus.success;
  bool get isError => this == AllPostStatus.error;
  bool get isLoading => this == AllPostStatus.loading;
